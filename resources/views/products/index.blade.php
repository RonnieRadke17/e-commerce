...
<main class="p-8 flex-grow relative">
    ...
    <button class="fixed bottom-8 right-8 bg-green-600 text-white w-16 h-16 rounded-full shadow-lg hover:bg-green-600 transition duration-300 flex items-center justify-center">
        <a href="{{route('products.create')}}" class="fas fa-plus"></a>
    </button>
