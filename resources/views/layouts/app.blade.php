...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <footer class="bg-red-600 text-white text-center py-4">
        <div class="contact flex space-x-4">
    <a href="https://facebook.com" class="flex justify-center items-center text-gray-300 hover:text-red-400 mx-2">
    ...
    <a href="https://instagram.com" class="flex justify-center items-center text-gray-300 hover:text-red-400 mx-2">
    ...
    <a href="https://twitter.com" class="flex justify-center items-center text-gray-300 hover:text-red-400 mx-2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" class="w-6 h-6">
    ...
    <a href="https://www.tiktok.com/es/" class="flex justify-center items-center text-gray-300 hover:text-red-400 mx-2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" class="w-6 h-6">
